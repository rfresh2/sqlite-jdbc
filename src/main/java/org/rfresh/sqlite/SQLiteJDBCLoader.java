...
/**
 * Set the system properties, org.rfresh.sqlite.lib.path, org.rfresh.sqlite.lib.name, appropriately so that the
...
public class SQLiteJDBCLoader {
    ...
    private static File getTempDir() {
        return new File(
                System.getProperty("org.rfresh.sqlite.tmpdir", System.getProperty("java.io.tmpdir")));
    }
    ...
    private static void loadSQLiteNativeLibrary() throws Exception {
        ...
        // Try loading library from org.rfresh.sqlite.lib.path library path */
        String sqliteNativeLibraryPath = System.getProperty("org.rfresh.sqlite.lib.path");
        String sqliteNativeLibraryName = System.getProperty("org.rfresh.sqlite.lib.name");
