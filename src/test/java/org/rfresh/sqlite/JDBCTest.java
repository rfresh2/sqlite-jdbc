...
public class JDBCTest {
    ...
    public void enableLoadExtensionTest() throws Exception {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:rfresh_sqlite:", prop)) {
    ...
    public void majorVersion() throws Exception {
        int major = DriverManager.getDriver("jdbc:rfresh_sqlite:").getMajorVersion();
        int minor = DriverManager.getDriver("jdbc:rfresh_sqlite:").getMinorVersion();
    }
    ...
    public void allDriverPropertyInfoShouldHaveADescription() throws Exception {
        Driver driver = DriverManager.getDriver("jdbc:rfresh_sqlite:");
        ...
        SQLiteConnection connection =
                (SQLiteConnection)
                        DriverManager.getConnection(
                                "jdbc:rfresh_sqlite::memory:?jdbc.explicit_readonly=true");
    ...
    public void jdbcHammer(@TempDir File tempDir) throws Exception {
        ...
        dataSource.setUrl("jdbc:rfresh_sqlite:" + tempFile.getAbsolutePath());
        try (Connection connection = dataSource.getConnection()) {
            connection.setAutoCommit(false);
